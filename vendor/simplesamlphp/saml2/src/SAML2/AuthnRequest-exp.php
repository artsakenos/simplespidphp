...
class AuthnRequest extends Request
{
    ...
    {
        $root = parent::toUnsignedXML(); // CHG+ added arg

        // CHG+ begin
        //$root->prefix='saml2p';
        //$root->setAttribute('xmlns:dsig', 'http://www.w3.org/2000/09/xmldsig#');
        //$root->setAttribute('xmlns:enc', 'http://www.w3.org/2001/04/xmlenc#');
        //$root->setAttribute('xmlns:x500', 'urn:oasis:names:tc:SAML:2.0:profiles:attribute:X500');
        //$root->setAttribute('xmlns:xsi', 'http://www.w3.org/2001/XMLSchema-instance');        
        // CHG+ end
        //CHG+ added next 3 lines
        /*
        if ($root->hasAttribute('xmlns:saml')) {
            $suxs = $root->removeAttribute('xmlns:saml');
            if (!$suxs) $suxs="0";
            echo $suxs;
            exit;
        }
        ...
        $this->assertionConsumerServiceIndex = 0; // CHG+ line added
        ...
        // CHG+ Debug
        //echo "<pre>";
        //print_r($e->firstChild);
        //exit;
        //CHG+ added next 2 lines
        //$e->firstChild->prefix = 'saml2';
        //$e->firstChild->setAttribute('xmlns:saml','urn:oasis:names:tc:SAML:2.0:assertion');
        //$e->firstChild->removeAttribute('xmlns');
