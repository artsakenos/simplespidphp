...
$config = array(
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://@commonName/spid/',    // CHG
    'certdir' => 'cert/',
    'loggingdir' => 'log/',
    'datadir' => 'data/',
     ...
     *
     */
    'logging.level' => SimpleSAML_Logger::ALERT,
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'sqlite:@abs_lib_path/sqlitedatabase.sq3',    // CHG
     ...
     */
    'memcache_store.prefix' => 'simplesaml_',
